...
<body>
  ...
  <!-- Skip link (temporarily disabled) -->
  <!-- <a href="#main-content" class="skip-link">Skip to main content</a> -->

  <!-- ===================================================
       TOPBAR
  =================================================== -->
	<div class="topbar" role="banner" aria-label="Utility navigation">
		<a href="/es/" class="topbar__link" lang="es" aria-label="Ver en Español">Español</a>
		<div class="topbar__divider" aria-hidden="true"></div>
		<a href="https://www.capk.org/donate/" class="topbar__link topbar__btn topbar__btn--donate"
		target="_blank" rel="noopener noreferrer" aria-label="Donate Now (opens in new tab)">
		Donate Now
		</a>
		<a href="https://www.capk.org/newsletter/" class="topbar__link topbar__btn topbar__btn--newsletter"
		target="_blank" rel="noopener noreferrer" aria-label="Newsletter Signup (opens in new tab)">
		Newsletter Signup
		</a>
	</div>
  ...
  <header class="site-header" role="banner">
    <div class="site-header__inner">
		...
		<img 
			...
			this.src='https://www.capk.org/wp-content/themes/capk-new/images/logo.png'">
		</a>
		...
		<a href="/index.php" class="site-header__nav-link site-header__nav-link--active" aria-current="page">2-1-1 Kern County</a>
    ...
    <!-- Mobile nav drawer -->
    <nav class="site-header__nav-drawer" id="mobile-nav-drawer" hidden aria-label="Mobile navigation">
      <a href="https://www.capk.org/about/" class="site-header__nav-link">About</a>
      <a href="https://www.capk.org/programs/" class="site-header__nav-link">Programs</a>
      <a href="/index.php" class="site-header__nav-link site-header__nav-link--active" aria-current="page">2-1-1 Kern County</a>
      <a href="https://www.capk.org/get-involved/" class="site-header__nav-link">Get Involved</a>
  ...
  <main id="main-content" class="map-section" aria-label="Resource map and search">
    ...
    <div class="search-bar" role="search" aria-label="Search for resources">
      	...
      	<div class="search-bar__top">
			<!-- Search icon -->
			<svg class="search-bar__icon" aria-hidden="true" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
			<circle cx="11" cy="11" r="8"/><path d="m21 21-4.35-4.35"/>
			</svg>

			<label for="search-input" class="sr-only">Search for food, housing, health, and other resources</label>
			<input
			type="search"
			id="search-input"
			...
			<!-- Clear button -->
			<button class="search-bar__clear <?= !empty($url_search) ? 'visible' : '' ?>"
				id="search-clear"
			...
			<!-- Collapse toggle — mobile only, hides pills row to save space -->
			<button class="search-bar__collapse-btn"
      ...
      <!-- Collapsible area: pills row (hidden when search bar is collapsed on mobile) -->
      ...
      <div class="search-bar__pills" role="list" aria-label="Quick category filters">
		<button class="pill" role="listitem" data-keyword="Fresh Food" aria-pressed="false">
		<span class="pill__icon" aria-hidden="true">🥦</span> Fresh Food
		</button>
		<button class="pill" role="listitem" data-keyword="Soup Kitchens" aria-pressed="false">
		<span class="pill__icon" aria-hidden="true">🍲</span> Soup Kitchens
		</button>
		<button class="pill" role="listitem" data-keyword="Food Vouchers" aria-pressed="false">
		<span class="pill__icon" aria-hidden="true">🎟️</span> Food Vouchers
		</button>
		<button class="pill" role="listitem" data-keyword="WIC" aria-pressed="false">
		<span class="pill__icon" aria-hidden="true">👶</span> WIC
		</button>
		<button class="pill" role="listitem" data-keyword="Specialty Food Providers" aria-pressed="false">
		<span class="pill__icon" aria-hidden="true">🌿</span> Specialty Food
		</button>
		<button class="pill" role="listitem" data-keyword="Brown Bag Food Program" aria-pressed="false">
		<span class="pill__icon" aria-hidden="true">🛍️</span> Brown Bag
		</button>
		<button class="pill" role="listitem" data-keyword="Post Disaster Food Services" aria-pressed="false">
		<span class="pill__icon" aria-hidden="true">🆘</span> Disaster Food
		</button>
		<button class="pill" role="listitem" data-keyword="Food Pantries" aria-pressed="false">
		<span class="pill__icon" aria-hidden="true">📦</span> Food Pantries
		</button>
		<button class="pill" role="listitem" data-keyword="CalFresh" aria-pressed="false">
		<span class="pill__icon" aria-hidden="true">🌾</span> CalFresh
		</button>
		</div>
    ...
    <!-- Near Me button -->
    <button class="btn-near-me" id="btn-near-me" type="button" aria-label="Show resources near my location">
      <svg aria-hidden="true" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
	...
	<button class="results-panel__close"
      ...
      <div class="results-panel__list" id="results-list" role="list" aria-label="Program results" tabindex="0"></div>
    </aside>

    <!-- ===================================================
	 MOBILE BOTTOM SHEET
    =================================================== -->
    <div class="bottom-sheet" id="bottom-sheet" role="region" aria-label="Search results" hidden>
	...
	<button class="results-panel__close"
      ...
      <div class="bottom-sheet__list" id="mobile-results-list" role="list" aria-label="Program results"></div>
    </div>
